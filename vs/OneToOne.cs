...
namespace excel {
    class OneToOne {
        ...
        public string CsPathDir = @"E:\wj\excel1\";
        public string DataPathDir = @"E:\wj\excel1\";
        public string XlsPathDir = @"E:\wj\excel\";

        public string tabs = "\t";
        public string newline = "\r\n";

        public FileStream DataFileStream;
        public BinaryWriter DataBinaryWriter;

        public string e_TablePath = @"E:\wj\excel1\e_Table.cs";
        public string Enum_TableData = "public enum e_TableType {" + "\r\n";

        /// <summary>
        /// 删除存在的文件
        /// </summary>
        public void DeleteFile(string _dataPath) {
        ...
        public void CreatDataFileStream(string _dataPath) {
            if (DataUtil.IsExits(_dataPath)) {
                File.Delete(_dataPath);
            }
        ...
        /// 关闭数据包文件流
        /// </summary>
        public void CloseDataFileStream() {
        ...
        void ImportOneExcelFile(string excelPath) {
        ...
        public void ImportOneLineData(int column, IRow twoRow, IRow row) {
        ...
        public void WriteScriptText(string csPath, string str) {
            try {
        ...
        public void DeclarationDescriptionInterface(IRow firstRow, IRow twoRow, string csPath) {
            try {
                int cellCount = firstRow.LastCellNum;//列数
                ...
                classTab += "public class I" + className + " {" + newline;
                string classEnd = "}" + newline;


                string classStr = string.Empty;
                string classStr1 = tabs + "public I" + className + "(BinaryReader br) {" + newline;

                for (int i = 1; i < cellCount; i++) {
                    string dataType = twoRow.GetCell(i).StringCellValue;
                    string dataName = firstRow.GetCell(i).StringCellValue;
                    classStr += tabs + "public readonly " + dataType + " " + dataName + ";" + newline;
